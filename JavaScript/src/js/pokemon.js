...
function damage(pokemon1, pokemon2){
    let damage = 50 * (pokemon1.attack / pokemon1.defense) * defineEffectiveness(pokemon1.tipo, pokemon2.tipo);
...
function mainFunction(){
    ...
    console.log(`Fire attack ${pokemonGrass.attack} defense ${pokemonGrass.defense}`);
    console.log(`Fire attack ${pokemonWater.attack} defense ${pokemonWater.defense}`);
    console.log(`Fire attack ${pokemonElectric.attack} defense ${pokemonElectric.defense}`);
